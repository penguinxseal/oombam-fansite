...
// =========================================================
// HOMEPAGE 15.42 — MEDIA DETAIL MODAL
// =========================================================
(() => {
  ...
  const DATA = {
    ...
    sakura: { eyebrow:'Special Collection', title:'When SAKURA Blooms', image:'https://instagram.fmnl40-2.fna.fbcdn.net/v/t51.71878-15/727286008_1069176428872871_3360453299667440480_n.jpg?stp=dst-jpg_e15_tt6&_nc_cat=100&ig_cache_key=MzkyNTAwMTY0OTI0ODQ4MTUyMjQ0NzYzNDUyNTI2MjQ4Nzc%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6IkNMSVBTLnhwaWRzLjY0MC5zZHIudmlkZW9fbmZyYW1lX2NvdmVyX2ZyYW1lLkMzIn0%3D&_nc_ohc=PhQ_HO6gabAQ7kNvwG-1sVc&_nc_oc=AdrM2QmtGm9c4J2k1MnWlzpcn7z7jJtaPx9KlxDQTH9_kyzM6RDbOxbYaGdi0_C5r44&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=instagram.fmnl40-2.fna&_nc_gid=ciLXm1OV97sXuCLPdQOY2w&_nc_ss=7a22e&oh=00_AQIChYArzyQuVwsxQ0N6fxGN6GfGCrUcPI4Tpsy3dqQr5w&oe=6AA32AFA', description:'A curated collection of intimate and candid clips shared during the Fulfill journey — the small interactions and memories that bloomed alongside the series.', credit:'Source: Instagram', creditUrl:'https://www.instagram.com/p/DZ4aDRWRzDy/', actions:[['View original post','https://www.instagram.com/p/DZ4aDRWRzDy/']] },
  ...
  const close=()=>{modal.classList.remove('is-open');modal.setAttribute('aria-hidden','true');delete modal.dataset.mediaKey;modal.querySelectorAll('.media-detail-modal__video').forEach(el=>el.remove());img.hidden=false;document.body.classList.remove('modal-open')};
