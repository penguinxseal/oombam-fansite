...
(() => {
  ...
  if (!modal) return;
  const DATA = {
    fulfill: { eyebrow:'Series', title:'Fulfill', image:'assets/images/OB_Media_Fulfill.jpeg?v=15.51', description:'Return to the story that started it all — from official episodes and behind-the-scenes material to special content and teasers from the Fulfill era.', credit:'Scan: emjoy · Blooming With You Photobook · @oombam_ch3', creditUrl:'https://www.instagram.com/oombam_ch3?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==', actions:[['Explore Fulfill','just-the-two-of-us.html'],['View original post','https://www.instagram.com/reel/DXTrNvUkfT_/']] },
    sakura: {
      eyebrow:'Special Collection',
      title:'When SAKURA Blooms',
      image:'assets/images/OB_Media_Sakura.jpeg?v=15.51',
    ...
    soundtrack: { eyebrow:'Soundtrack', title:'Fulfill OST', image:'', videoId:'RHnPq3Z0A8c', playlistIds:'RHnPq3Z0A8c,CKclkO6HHrY', description:'The official Fulfill soundtrack, performed by Oom Eisaya and Bam Saralee.', credit:'Official soundtrack · YouTube', actions:[['Oom Eisaya ↗','https://youtu.be/RHnPq3Z0A8c?si=doOy3CnVHBzP7ASw'],['Bam Saralee ↗','https://youtu.be/CKclkO6HHrY?si=vwnpGo217i5dTE7D']] }
  };
