...
(() => {
  ...
  const DATA = {
    ...
    soundtrack: { eyebrow:'Soundtrack', title:'Fulfill OST', image:'', videoId:'RHnPq3Z0A8c', description:'The official Fulfill soundtrack, performed by Oom Eisaya and Bam Saralee.', credit:'Official soundtrack · YouTube', actions:[['Oom Eisaya ↗','https://youtu.be/RHnPq3Z0A8c?si=doOy3CnVHBzP7ASw'],['Bam Saralee ↗','https://youtu.be/CKclkO6HHrY?si=vwnpGo217i5dTE7D']] }
  };
